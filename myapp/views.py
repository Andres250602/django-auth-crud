...
def task_details(request, task_id):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'task_details.html', {'task': task, 'form': form, 'error': "Error al actualizar tarea"})
...
def tasks_completed(request):
    tasks = tarea.objects.filter(user=request.user, datecompleted__isnull=False ).order_by 
    ('-datecompleted')
    return render(request, 'tasks.html', {'tasks': tasks})
